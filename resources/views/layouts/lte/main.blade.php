...
<html lang="en">
    ...
    <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
      ...
      <!--end::App Wrapper-->
      <script src="https://cdn.jsdelivr.net/npm/overlayscrollbars@2.11.0/lib/overlayscrollbars.min.js" crossorigin="anonymous">
      </script>
      <script src="https://cdn.jsdelivr.net/npm/@poperjs/core@2.11.6/dist/umd/popper.min.js" crossorigin="anonymous">
      </script>
    ...
    <script>
        ...
        const Default = {
            ...
            scrollbarClickScrolling: true,
            scrollbarFadeScrollbars: true,
        };
            ...
            if (sidebarWrapper && OverlayScrollbarsGlobal?.OverlayScrollbars !== undefined) {
                OverlayScrollbarsGlobal.OverlayScrollbars(sidebarWrapper, {
                    scrollbars: {
                        ...
                        clickScrolling: Default.scrollbarClickScrolling,
                        fadeScrollbars: Default.scrollbarFadeScrollbars,
                    },
                });
            }
            });
